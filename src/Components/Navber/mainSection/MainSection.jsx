...
const MainSection = ({tikitData,setProgress,progress,setResolve,resolve,removeTaskStatus}) => {
    ...
    return (
        <div className="grid grid-cols-3 gap-10 mt-10 p-5 ">
            <div className=' col-span-2 '>
                <h1 className='text-3xl font-semibold mb-5'>Customer Tickets</h1>
            <div className="grid grid-cols-2 gap-3">
                {
                datas.map(data => <Card1 setProgress={setProgress} data={data} progress={progress} ></Card1>)
            }
            </div>
            ...
            <div className=' col-span-1  '>
                ...
                {
                    progress.map(TaskStatus => <Card2 TaskStatus={TaskStatus} setResolve={setResolve} resolve={resolve} progress={progress} removeTaskStatus={removeTaskStatus}></Card2>)
                }
